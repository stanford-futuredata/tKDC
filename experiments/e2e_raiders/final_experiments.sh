...
./run2.sh experiments/e2e_raiders/ic2/tmy3_4.yaml | tee experiments/e2e_raiders/ic2/out/tmy3_4.out
...
./run2.sh experiments/e2e_raiders/simple/tmy3_4.yaml | tee experiments/e2e_raiders/simple/out/tmy3_4.out
